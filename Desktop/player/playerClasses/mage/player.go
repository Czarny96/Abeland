components {
  id: "player"
  component: "/player/playerClasses/mage/player.script"
  position {
    x: 0.0
    y: 0.0
    z: 0.0
...
components {
  id: "attack"
  component: "/player/playerClasses/mage/attack/attack.script"
  position {
    x: 0.0
    y: 0.0
    z: 0.0
...
embedded_components {
  ...
  type: "factory"
  data: "prototype: \"/player/playerClasses/mage/attack/basic/projectile.go\"\n"
...
embedded_components {
  id: "attack-iceNovaFactory"
  type: "factory"
  data: "prototype: \"/player/playerClasses/mage/attack/iceNova/projectile.go\"\n"
  "load_dynamically: false\n"
  ""
  position {
    x: 0.0
